        ...
        return (
          ...
          >
            <motion.button
              ...
              aria-label={`Ask about ${suggestion.label}`}
            >
              {/* Gradient background overlay that appears on hover */}
              <motion.div 
                className={`absolute inset-0 bg-gradient-to-br ${suggestion.gradient} opacity-0 group-hover:opacity-100 rounded-lg`}
                initial={{ opacity: 0 }}
              ...
              <div className="relative flex flex-col items-center justify-center h-full space-y-1 z-10">
                ...
                <span className="text-xs leading-tight text-center transition-colors duration-300 px-1">
                  {suggestion.label}
                </span>
              </div>
              ...
              <motion.div 
                className="absolute inset-0 w-6 h-full bg-white opacity-30 transform rotate-12 translate-x-[-100%] group-hover:translate-x-[300%] transition-transform duration-700 z-20 rounded-lg"
                initial={{ x: "-100%" }}
                whileHover={{ x: "300%" }}
